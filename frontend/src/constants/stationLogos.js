// frontend/src/constants/stationLogos.js
// Station logo constants for Southern Power Syndicate

export const SOUTHERN_POWER_NETWORK = {
  slug: "southern-power-network",
  name: "Southern Power Network",
  logoUrl: "/logos/southernpowernetworklogo.png",
  tagline: "Music videos & local shows",
